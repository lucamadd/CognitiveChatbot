...
$(document).ready(function () {
    ...
    var addButton3 = $('#addField3'); //Add button selector
    var wrapper3 = $('.field_wrapper3'); //Input field wrapper
    var x3 = 1; //Initial field counter is 1
    var fieldHTML3 = '<div><input class="multiple-input" type="text" name="params[]" value=""/><input type="button" class="remove-button" id = "removeField3" value="Rimuovi" ></input></div>'; //New input field html 
...
var addButton4 = $('#addMulti'); //Add button selector
var wrapper4 = $('.field_wrapper4'); //Input field wrapper
var x4 = 0; //Initial field counter is 0
var fieldHTML4 = '<div><input class="multiple-input" type="text" name="multi[]" value=""/><input type="button" class="remove-button" id = "removeField4" value="Rimuovi" ></input></div>'; //New input field html 
...
//Once remove button is clicked
$(wrapper4).on('click', '#removeField4', function(e){
	e.preventDefault();
	$(this).parent('div').remove(); //Remove field html
...
function addAction(){
    ...
    if (tag == "" || patterns[0] == "" || responses[0] == "" || url == ""){
